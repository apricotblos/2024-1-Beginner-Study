...
- 답: 1 - a, b, c의 커밋이 그대로 main 브랜치로 병합, 2 - 하나의 커밋으로 main 브랜치로 병합, 3 - 모두 새로운 커밋으로 변경
...
- 답: develop 브랜치에서 작업중이며 readme 파일이 추가됨
...
- 답: revert. reset을 사용할 경우 커밋이 아예 삭제되기 때문. 상대가 해당 commit을 필요로 할 수 있으며 수정사항을 확인할 수 있어야 함
